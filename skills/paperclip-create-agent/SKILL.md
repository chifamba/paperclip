...
description: >
  Create new agents in Agents with governance-aware hiring. Use when you need
  to inspect adapter configuration options, compare existing agent configs,
  draft a new agent prompt/config, and submit a hire request.
---

# Agents Create Agent Skill
...
2. Discover available adapter configuration docs for this Agents instance.
...
- if the role needs skills, make sure they already exist in the company library or install them first using the Agents company-skills workflow
